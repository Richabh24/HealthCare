<div class="generic-container">
    <div class="panel panel-default">
        ...
        <div class="panel-heading"><span class="lead">Patient form </span></div>
	            ...
	            <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
	                ...
	                <div class="row">
	                    <div class="form-group col-md-12">
	                        ...
	                        <date-picker ng-model="ctrl.user.dob" format-date="formatDate" parse-date="parseDate"  required>
</date-picker>
<input ng-model="ctrl.user.dob">
	                        </div>
	                    </div>
	                </div>
    ...
    <div class="panel panel-default">
        <!-- Default panel contents -->
        <div class="panel-heading"><span class="lead">List of Patient </span></div>
		<div class="panel-body">
